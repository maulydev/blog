  ...
  return (
    <div className="space-y-4 text-xl dark:text-gray-100">
      ...
      <div className="relative h-96 rounded-lg overflow-hidden dark:border-2 dark:border-gray-600">
        ...
        />
        <div className="absolute rounded bottom-0 outline outline-4 outline-white outline-offset-2 m-4">
          <img
      ...
      <div className="space-y-4">
        <p>
          ...
          actually I am <strong>Trapcy</strong> , an accomplished full-stack web
